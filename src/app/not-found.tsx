  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-4 text-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <Link
          href="/"
          className="mt-2 inline-flex items-center gap-2 rounded-lg bg-brand-primary px-5 py-2.5 text-sm font-bold text-wood-dark transition-colors hover:bg-brand-primary-hover"
        >
          Torna a l&apos;inici
        </Link>
      </div>
